...
<xsl:stylesheet version="3.0" 
    ...
    <!-- Global parameters -->
    <xsl:param name="input-files" as="xs:string*"/><!-- (optional) paths to DC input files -->
    ...
    <xsl:template name="generate-cff-yaml">
        ...
        <!-- message -->
        <xsl:text>message: "This CFF file was generated using the mei-metadata-toolkit (https://github.com/Edirom/mei-metadata-toolkit)"</xsl:text>
