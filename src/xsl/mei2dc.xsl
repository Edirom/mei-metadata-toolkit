...
<xsl:stylesheet version="3.0" 
    ...
    xmlns:fx="http://www.example.com/fx"
    exclude-result-prefixes="mei fx xs">
    ...
    <xsl:template name="generate-oai_dc-xml">
        ...
        <oai_dc:dc xsi:schemaLocation="http://www.openarchives.org/OAI/2.0/oai_dc/ http://www.openarchives.org/OAI/2.0/oai_dc.xsd">
            ...
            <xsl:for-each select="//mei:revisionDesc/mei:change">
                ...
                <xsl:if test="position() = 1">
                    <dc:identifier>Version: <xsl:value-of select="fx:join-descendants(mei:changeDesc, ' ')"/></dc:identifier>
                </xsl:if>
            </xsl:for-each>
            ...
            <xsl:for-each select="//mei:fileDesc/mei:sourceDesc/mei:source">
                <dc:source>
                    <xsl:value-of select="fx:join-descendants(., '; ')"/>
                </dc:source>
            </xsl:for-each>
    ...
    <xsl:function name="fx:join-descendants" as="xs:string">
